...
if(!in_array($page, array('home','about','services','corporate-law','tax-law','legal_updates','contact','quote_send','contact_send','submit','legal-detail','event-detail','gallery')))
        ...
        <div class="header">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <a href="./"><img src="images/logo1.png" style="position: absolute; z-index: 1; width: 150px;"></a>
                    </div>
                    <div class="col-md-8">
                        <a href="tel:9802100104" style="text-decoration:none;">
                        ...
                        <nav id="menu">
                            ...
                            <ul class="main-menu clearfix">
                                ...
                                <li class="<?php if($page=='about'){echo 'active';} ?>"><a href='./about'>About Me</a></li>
                                <li><a href="#">Services <i class="fa fa-angle-down" aria-hidden="true"></i> <span class="drop-icon">▾</span> <label
                                            title="Toggle Drop-down" class="drop-icon" for="sm1">▾</label></a>
                                    <input type="checkbox" id="sm1">
                                    <ul class="sub-menu">

                                        <li><a href="./corporate-law">Corporate Law</a></li>
                                        <li><a href="./tax-law">Tax law</a></li>
                                    </ul>
                                </li>
                                <li class="<?php if($page=='legal_updates'){echo 'active';} ?>"><a
                                        href='./legal_updates'>Legal Updates</a></li>
                                 <li class="<?php if($page=='gallery'){echo 'active';} ?>"><a
                                        href='./gallery'>Gallery</a></li>
                                <li class="<?php if($page=='contact'){echo 'active';} ?>"><a
